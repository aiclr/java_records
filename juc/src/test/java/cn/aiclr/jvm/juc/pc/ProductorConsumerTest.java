...
class ProductorConsumerTest {
    ...
    @Test
    @DisplayName("ReentrantLock 可重入锁")
    void testLock() {
        ClerkLock clerk2 = new ClerkLock();

        ProductorLock productor2 = new ProductorLock(clerk2);
        ConsumerLock consumer2 = new ConsumerLock(clerk2);
