 ...
 * 在 Java 中它确实没有 List、Set、Map 这些集合类用起来方便，
...
public class Ch {
    ...
    /**
     * <pre>拆箱
     * Integer 对象通过 intValue 方法自动转换成了一个 int 基本类型，
     * 对于性能濒于临界的系统来说该方案是比较危险的，特别是大数量的时候
     *
     * 首先，在初始化 List 数组时要进行装箱动作，把一个 int 类型包装成一个 Integer 对象，
     * 虽然有整型池在，但不在整型池范围内的都会产生一个新的 Integer 对象，
