...
public class Ce {
    public static void main(String[] args) {
        ...
        while (input.hasNext()) {
            ...
            System.out.println("\"" + str + "\" 的单词数是：" + wordsCount);
        }
    }
}