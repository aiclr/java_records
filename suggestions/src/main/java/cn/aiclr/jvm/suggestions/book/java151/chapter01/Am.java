 ...
 *      8个基本类型
 *      数组
 *      字符串,字符串情况很复杂，不通过new关键字生成String对象的情况下，final变量的赋值与基本类型相同,但是不能方法赋值
 *  原理：
 ...
 *          2.通过方法返回值为 final 变量赋值
 *              {@link cn.aiclr.jvm.suggestions.book.java151.chapter01.AlTest#testV1Method()}
 *              {@link cn.aiclr.jvm.suggestions.book.java151.chapter01.AlTest#testV2Method()}
 *          3.final 修饰的属性不是 基本类型
