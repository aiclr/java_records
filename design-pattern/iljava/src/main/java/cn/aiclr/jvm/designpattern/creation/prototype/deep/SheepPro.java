package cn.aiclr.jvm.designpattern.creation.prototype.deep;
...
public class SheepPro implements Serializable, Cloneable {
    ...
    private static final Logger log = LoggerFactory.getLogger(SheepPro.class);
